...
angular.module('QuotationApp.masters').controller('clientQuoteRecyCatalogueController',['$rootScope','rechercheClientService', 'clientQuoteRecyCatalogueService', '$scope', '$http', function($rootScope, rechercheClientService, clientQuoteRecyCatalogueService ,$scope, $http) {
